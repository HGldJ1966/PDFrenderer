 ...
 * <li>An intermediate node contains the limits of all the children in its subtree, and a kids entry
 * for each child
 * <li>A leaf node contains a set of name-to-object mappings in a dictionary, as well as the limits
 * of the data contained in that child.
 * </ul>
