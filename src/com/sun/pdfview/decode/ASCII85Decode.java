...
public class ASCII85Decode {
	...
	private boolean decode5(ByteArrayOutputStream baos)
		...
		for (i = 0; i < 5; i++) {
			...
			if (five[i] == '~') {
				...
				throw new PDFParseException("Bad character in ASCII85Decode: " + five[i] + " ("
						+ (char) five[i] + ")");
			}
		}
	 ...
	 * <p>
	 * In ASCII85 format, every 5 characters represents 4 decoded bytes in base 85. The entire
	 * stream can contain whitespace, and ends in the characters '~&gt;'.
	 * 
	 * @param buf
