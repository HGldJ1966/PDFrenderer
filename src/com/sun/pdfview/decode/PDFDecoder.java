 ...
 * <p>
 * You should use the decodeStream() method of this object rather than using any of the decoders
 * directly.
 */
public class PDFDecoder {

	public final static Set<String> DCT_FILTERS = new HashSet<String>(Arrays.asList("DCT",
			"DCTDecode"));
	...
	public static ByteBuffer decodeStream(PDFObject dict, ByteBuffer streamBuf,
		...
		if (filter == null) {
			...
			for (int i = 0; i < spec.ary.length; i++) {
				...
				if (enctype == null) {} else if (enctype.equals("FlateDecode")
						|| enctype.equals("Fl")) {
					...
					throw new PDFParseException("Unknown coding method:"
							+ spec.ary[i].getStringValue());
				}
			}
		}
