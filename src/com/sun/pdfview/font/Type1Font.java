...
public class Type1Font extends OutlineFont {
	 ...
	 * <p>
	 * this function attempts to parse an array out of a postscript definition without doing any
	 * postscript. It's actually looking for things that look like "dup <i>id</i> <i>elt</i> put",
	 * and placing the <i>elt</i> at the <i>i</i>th position in the array.
	 * 
	 * @param d
	 *            the font definition stream
	 * @param key
