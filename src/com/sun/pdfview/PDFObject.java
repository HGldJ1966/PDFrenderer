 ...
 * <p>
 * A PDF object can be a simple type, like a Boolean, a Number, a String, or the Null value. It can
 * also be a NAME, which looks like a string, but is a special type in PDF files, like "/Name".
 * <p>
 * A PDF object can also be complex types, including Array; Dictionary; Stream, which is a
 * Dictionary plus an array of bytes; or Indirect, which is a reference to some other PDF object.
 * Indirect references will always be dereferenced by the time any data is returned from one of the
...
public class PDFObject {
	 ...
	 * embedded within another object. If the value is {@link #OBJ_NUM_TRAILER}, it's because it's
	 * an object from the trailer.
	 * 
	...
	public boolean equals(Object o) {
		if (super.equals(o)) {
			...
			if (obj.type == INDIRECT) {
				...
				return ((lXref.getID() == rXref.getID()) && (lXref.getGeneration() == rXref
						.getGeneration()));
			}
		}
